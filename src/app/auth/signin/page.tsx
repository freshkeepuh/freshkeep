...
/**
 * Branding header with logo and app title.
 *
 * @component
...
/**
 * Welcome message shown on the left side of the sign-in page.
 *
 * @component
...
/**
 * Sign-in form that handles authentication via NextAuth.
 *
 * @component
...
/**
 * Main sign-in page layout with welcome message and sign-in form.
 *
 * @component
