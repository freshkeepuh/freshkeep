...
const Welcome: React.FC = () => (
  <Container id="welcome-page" fluid className={`text-center py-5 ${styles.welcomeContainer}`}>
    <Row className="align-items-center justify-content-center fade-in px-md-5 px-3">
      ...
      <Col xs={12} md={4} className="mb-5 mb-md-0">
        ...
        <h4 className="text-muted mb-4">Your personal food management assistant</h4>
      </Col>
    ...
    <Row className="align-items-center justify-content-center fade-in px-md-5 px-3">
      {/* List of Features */}
      <Col xs={12} md={4} className="flex-column justify-content-center text-start">
