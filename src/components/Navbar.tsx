          ...
          >
            ...
            <Offcanvas.Body data-testid="navbar-offcanvas-body">
              ...
              <Nav data-testid="navbar-nav" className="ms-auto">
                ...
                <Nav.Link data-testid="navbar-link-stores" as={Link} href="/stores" active={isActive('/stores')}>
                  Stores
                </Nav.Link>
                <Nav.Link data-testid="navbar-link-recipes" as={Link} href="/recipes" active={isActive('/recipes')}>
                  Recipes
                </Nav.Link>
                <NavDropdown
