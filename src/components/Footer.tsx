      ...
      <Container className="d-flex flex-column gap-2">
        <Row>
          <Col
            xs={12}
            md={4}
            className="d-flex justify-content-start align-items-center opacity-75 fw-semibold"
          >
            Copyright &copy;
          ...
          <Col
            xs={12}
            md={4}
            className="d-flex justify-content-end align-items-center opacity-75 fw-semibold"
          >
            <Link
