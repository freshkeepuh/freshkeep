...
//  * @param data, an object with grocery item properties: name, category, store, userId.
//  */
...
//     if (!unitId) {
//       // Try to find an storeing unit or create a default one
...
//       if (!defaultUnit) {
//         // Create a default unit if it doesn't store
...
//     if (data.userId) {
//       // Verify the user stores before creating shop entry
...
// /**
//  * Adds an storeing product to a user's catalog
...
//   try {
//     const shopItem = await prisma.catalog.create({
//       data: {
//         userId,
//         groceryItemId,
//       },
...
//     if (error.code === 'P2002') {
//       throw new Error('Item already stores in your shop');
//     }
//     throw error;
//   }
// }
...
//   const shopItem = await prisma.catalog.delete({
//     where: {
...
//   const shopItems = await prisma.catalog.findMany({
//     where: {
//       userId,
//     },
//     include: {
